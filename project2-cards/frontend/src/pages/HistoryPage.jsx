    ...
    <div className="min-h-screen p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-between items-center mb-8">
          <h1 className="font-cyber text-3xl text-neon-cyan">Історія карток</h1>
          <div className="flex gap-3">
            <Link to="/" className="btn-neon text-sm">Каталог</Link>
            <Link to="/randomizer" className="btn-neon-pink text-sm">Рандомізатор</Link>
          </div>
        </div>
              ...
              {!searched ? (
                <tr>
                  <td colSpan="6" className="py-8 text-center text-gray-500">
                    Введіть Session ID для перегляду історії
                  </td>
                </tr>
              ) : loading ? (
                <tr>
